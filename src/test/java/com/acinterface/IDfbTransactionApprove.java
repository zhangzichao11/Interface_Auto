...
public class IDfbTransactionApprove extends AWebApiService{
	...
	public IDfbTransactionApprove(int expStatus){
		
		HttpJson hpJson = new HttpJson();
		
		domain=gp.getBaseUrl();//read public api url
		url=gp.getTransactionApproveUrl();//read transCreate url
